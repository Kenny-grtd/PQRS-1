                    ...
                    rx.vstack(
                        rx.hstack(
                            ...
                            rx.box(
                                rx.vstack(
                                    ...
                                    rc.bar_chart(
                                        rc.x_axis(dataKey="name"),
                                        rc.y_axis(),
                                        rc.tooltip(),
                                        rc.bar(dataKey="cantidad", fill="#1D4ED8"),
                        ...
                        rx.hstack(
                            ...
                            rx.box(
                                rx.vstack(
                                    ...
                                    rc.line_chart(
                                        rc.x_axis(dataKey="month"),
                                        rc.y_axis(),
                                        rc.tooltip(),
                                        rc.line(type="monotone", dataKey="value", stroke="#1D4ED8", dot=True),
                        ...
                        rx.box(
                            rx.vstack(
                                ...
                                rc.pie_chart(
                                    rc.tooltip(),
                                        rc.pie(dataKey="value", nameKey="name", innerRadius="60%", outerRadius="80%", fill="#10b981"),
